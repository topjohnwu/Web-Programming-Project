	...
	constructor(props) {
		...
		this.state = {
			contacts: [{
					id: 0,
					name: "蔡英文",
					pic: "http://donate.iing.tw/images/iing.png",
					contents: [
						["誒誒你知道你的貼圖現在很夯嗎XD", true],
						["什麼鬼= =", false],
						[<img className="attach" src="http://goo.gl/MQCwPT"/>, true],
						["...........", false],
					],
					time: "11:20pm",
				}, {
					...
					id: 5,
					name: "馬英九",
					pic: "http://goo.gl/Ftpij0",
					contents: [
						["一個總統，施政滿意度只剩18%就可以下台了\
				，不下台就是沒有羞恥心！", false],
						["嗯...可是你只有9%誒", true],
						["你說什麼？我聽不到", false],
						["你耳朵長毛嗎？", true],
